    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-5">
            <div class="breadcrumb-title pe-3">
                <span class="text-lg font-bold text-slate-700">Repayments</span>
            </div>
            <div class="ps-3">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-slate-800 to-slate-900 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <h6 class="text-sm font-semibold uppercase tracking-wider text-white mb-0">Loan Repayments</h6>
                </div>
                    ...
                    <table id="example" class="table w-full" style="width:100%">
                        <thead>
                            <tr class="bg-slate-100 text-slate-600">
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider whitespace-nowrap">Remark</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach ($payments as $payment)
                            <tr class="border-t border-slate-100 hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm font-semibold text-slate-800 whitespace-nowrap">{{ number_format($payment->amount, 2) }}</td>
                                ...
                                <td class="px-4 py-3 text-sm text-slate-500">
                                    <span class="inline-block max-w-[140px] truncate" title="{{ $payment->remarks ?? 'N/A' }}">
                                        {{ $payment->remarks ?? 'N/A' }}
                                    </span>
                                </td>
                            </tr>

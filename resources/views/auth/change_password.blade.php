                            ...
                            <div class="">
                                ...
                                <div class="form-body">
                                    <form class="row g-3" id="user_auth">
                                        <div class="col-12">
                                            <label for="inputChoosePassword" class="form-label">Old Password</label>
                                            <div class="input-group" id="show_hide_password">
                                                <input type="password" name="old_password" class="form-control border-end-0" id="inputChoosePassword" value="12345678" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" id="user_btn" class="btn btn-primary"> <span class="bx bx-save"></span> Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       complete : function(){
            $('#user_btn').html('<span class="fas fa-save"></span> Submit');

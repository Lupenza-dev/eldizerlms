...
!(function (t, e) {
    ...
    function Me(t, e, i, s) {
        ...
        (h = Math.max(0, h - o.width)), (c = Math.max(0, s ? h / s : c - o.height)), (h = ve(Math.min(h, a, l.maxWidth))), (c = ve(Math.min(c, r, l.maxHeight))), h && !c && (c = ve(h / 2));
        return (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && ((c = l.height), (h = ve(Math.floor(c * s)))), { width: h, height: c };
    }
    function we(t, e, i) {
        const s = e || 1,
    ...
    function Ce(t, e, i, s) {
        ...
        for (h = 0; h < l; h++)
            ...
            else if (n(u)) for (c = 0, d = u.length; c < d; c++) (f = u[c]), null == f || n(f) || (r = De(t, o, a, r, f));
        t.restore();
        const g = a.length / 2;
        if (g > i.length) {
    ...
    function He(t, e = [""], i = t, s, n = () => t[0]) {
        ...
        const o = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: s, _getTarget: n, override: (n) => He([n, ...t], e, i, s) };
        return new Proxy(o, {
            ...
            get: (i, s) =>
                Xe(i, s, () =>
                    (function (t, e, i, s) {
                        let n;
                        for (const o of e) if (((n = Qe(Ye(o, t), i)), k(n))) return Ue(t, n) ? Ze(i, s, t, n) : n;
                    })(s, e, t, i)
                ),
    ...
    function je(t, e, i, s) {
        const a = { _cacheable: !1, _proxy: t, _context: e, _subProxy: i, _stack: new Set(), _descriptors: $e(t, s), setContext: (e) => je(t, e, i, s), override: (n) => je(t.override(n), e, i, s) };
        return new Proxy(a, {
                    ...
                    (function (t, e, i) {
                        ...
                        S(h) &&
                            ...
                            (h = (function (t, e, i, s) {
                                ...
                                r.add(t), (e = e(o, a || s)), r.delete(t), Ue(t, e) && (e = Ze(n._scopes, n, t, e));
                                return e;
                            })(e, h, t, i));
                        n(h) &&
                            h.length &&
        ...
        !(function (t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                (l = h),
                    ...
                    l &&
                        h &&
                        (V(e[c], 0, ii) ? (i[c] = i[c + 1] = 0) : ((n = i[c] / e[c]), (o = i[c + 1] / e[c]), (r = Math.pow(n, 2) + Math.pow(o, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[c] = n * a * e[c]), (i[c + 1] = o * a * e[c]))));
        })(t, n, o),
            (function (t, e, i = "x") {
                const s = ni(i),
                    n = t.length;
    ...
    function li(t, e, i, s, n) {
        let o, a, r, l;
        if ((e.spanGaps && (t = t.filter((t) => !t.skip)), "monotone" === e.cubicInterpolationMode)) ai(t, n);
        else {
            let i = s ? t[t.length - 1] : t[0];
            for (o = 0, a = t.length; o < a; ++o) (r = t[o]), (l = oi(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)), (r.cp1x = l.previous.x), (r.cp1y = l.previous.y), (r.cp2x = l.next.x), (r.cp2y = l.next.y), (i = r);
        }
        e.capBezierPoints &&
            (function (t, e) {
                let i,
                ...
                for (i = 0, s = t.length; i < s; ++i)
                    (a = o),
                        (o = r),
                        (r = i < s - 1 && Ee(t[i + 1], e)),
                        o && ((n = t[i]), a && ((n.cp1x = ri(n.cp1x, e.left, e.right)), (n.cp1y = ri(n.cp1y, e.top, e.bottom))), r && ((n.cp2x = ri(n.cp2x, e.left, e.right)), (n.cp2y = ri(n.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    const hi = (t) => 0 === t || 1 === t,
        ...
        ui = {
            ...
            easeInOutElastic(t) {
                const e = 0.1125;
                return hi(t) ? t : t < 0.5 ? 0.5 * ci(2 * t, e, 0.45) : 0.5 + 0.5 * di(2 * t - 1, e, 0.45);
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e);
            ...
            easeInOutBounce: (t) => (t < 0.5 ? 0.5 * ui.easeInBounce(2 * t) : 0.5 * ui.easeOutBounce(2 * t - 1) + 0.5),
        };
    function fi(t, e, i, s) {
    ...
    function wi(t, e) {
        ...
        const n = { family: l(t.family, e.family), lineHeight: xi(l(t.lineHeight, e.lineHeight), i), size: i, style: s, weight: l(t.weight, e.weight), string: "" };
    ...
    function Li(t, e, i) {
        ...
        for (let t = c, i = c; t <= d; ++t)
            (m = e[t % a]),
                m.skip || ((p = h(m[s])), p !== b && ((x = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ti({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (b = p)));
        return null !== _ && g.push(Ti({ start: _, end: d, loop: u, count: a, style: f })), g;
    }
    function Ei(t, e) {
        const i = [],
            s = t.segments;
    ...
    function Wi(t, e, i, s, n) {
        ...
        return (
            Ni(
                ...
                e,
                function (i, a, r) {
                    (n || Ee(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({ element: i, datasetIndex: a, index: r });
                },
                !0
            ),
            o
    ...
    function es(t, e, i, s) {
        ...
        for (o = 0, a = t.length, h = 0; o < a; ++o) {
            (r = t[o]), (l = r.box), l.update(r.width || e.w, r.height || e.h, ts(r.horizontal, e));
    ...
    function ss(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                const s = e.w * h,
                    o = l.size || t.height;
                k(l.start) && (a = l.start), t.fullSize ? is(t, n.left, a, i.outerWidth - n.right - n.left, o) : is(t, e.left + l.placed, a, s, o), (l.start = a), (l.placed += s), (a = t.bottom);
            } else {
                const s = e.h * h,
                    a = l.size || t.width;
            ...
            const n = Mi(t.options.layout.padding),
                ...
                r = (function (t) {
                    const e = (function (t) {
                        ...
                        r = qi(e, "x"),
                        l = qi(e, "y");
                    return { fullSize: i, leftAndTop: s.concat(o), rightAndBottom: n.concat(l).concat(a).concat(r), chartArea: Xi(e, "chartArea"), vertical: s.concat(n).concat(l), horizontal: o.concat(a).concat(r) };
                })(t.boxes),
                l = r.vertical,
                h = r.horizontal;
            u(t.boxes, (t) => {
    ...
    const rs = { touchstart: "mousedown", touchmove: "mousemove", touchend: "mouseup", pointerenter: "mouseenter", pointerdown: "mousedown", pointermove: "mousemove", pointerup: "mouseup", pointerleave: "mouseout", pointerout: "mouseout" },
        ls = (t) => null === t || "" === t;
    ...
    function us(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t) => {
                let e = !1;
                for (const i of t) (e = e || ds(i.addedNodes, s)), (e = e && !ds(i.removedNodes, s));
                e && i();
            });
    ...
    function fs(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t) => {
                let e = !1;
                for (const i of t) (e = e || ds(i.removedNodes, s)), (e = e && !ds(i.addedNodes, s));
                e && i();
            });
        return n.observe(document, { childList: !0, subtree: !0 }), n;
    }
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t
                ? ((function (t, e) {
                      ...
                      if (((t.$chartjs = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), ls(n))) {
                          const e = Se(t, "width");
                          void 0 !== e && (t.width = e);
                      }
                      if (ls(s))
    ...
    class Ps {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? ((n[l] = c = new Ss(d, t, l, h)), s.push(c)) : (t[l] = h);
            }
            return s;
        }
        update(t, e) {
    ...
    class Vs {
        ...
        applyStack(t, e, i) {
            const s = this.chart,
                n = this._cachedMeta,
                o = e[t.axis];
            return Os({ keys: Cs(s, !0), values: e._stacks[t.axis]._visualValues }, o, n.index, { mode: i });
        }
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                (n =
                    ...
                    (e.$context = (function (t, e, i) {
                        return Pi(t, { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" });
                    })(this.getContext(), t, e))),
                ...
                (n =
                    ...
                    (this.$context = (function (t, e) {
                        return Pi(t, { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset" });
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Fs(f, r)))), f;
        }
    ...
    function Ns(t, e) {
        ...
        if (r > 0) {
            ...
            for (Ws(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1; t < i; t++) Ws(e, c, d, a[t], a[t + 1]);
    ...
    class Ks extends Bs {
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(),
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = Si(this, n, s)), (this._dataLimitsCached = !0)),
            ...
            this._convertTicksToLabels(r ? $s(this.ticks, a) : this.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = Ns(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
        ...
        fit() {
            ...
            if (o) {
                ...
                if ((a ? ((t.width = this.maxWidth), (t.height = Us(n) + o)) : ((t.height = this.maxHeight), (t.width = Us(n) + o)), i.display && this.ticks.length)) {
        ...
        _computeLabelSizes(t, e, i) {
            ...
            for (c = 0; c < e; c += h) {
                if (((g = t[c].label), (p = this._resolveTickFontOptions(c)), (o.font = m = p.string), (b = a[m] = a[m] || { data: {}, gc: [] }), (x = p.lineHeight), (_ = y = 0), s(g) || n(g))) {
                    if (n(g)) for (d = 0, f = g.length; d < f; ++d) (v = g[d]), s(v) || n(v) || ((_ = De(o, b.data, b.gc, _, v)), (y += x));
                } else (_ = De(o, b.data, b.gc, _, g)), (y = x);
        ...
        drawBorder() {
            ...
            const a = s.setContext(this.getContext(0)).lineWidth,
                r = this._borderValue;
            let l, h, c, d;
            this.isHorizontal() ? ((l = Oe(t, this.left, o) - o / 2), (h = Oe(t, this.right, a) + a / 2), (c = d = r)) : ((c = Oe(t, this.top, o) - o / 2), (d = Oe(t, this.bottom, a) + a / 2), (l = h = r)),
                e.save(),
                (e.lineWidth = n.width),
        ...
        drawTitle() {
            ...
            const { titleX: c, titleY: d, maxWidth: u, rotation: f } = (function (t, e, i, s) {
                ...
                if (t.isHorizontal()) {
                    ...
                    } else g = "center" === i ? (c.bottom + c.top) / 2 + m - e : Hs(t, i, e);
                    u = l - a;
                } else {
                    if (o(i)) {
                        const t = Object.keys(i)[0],
                    ...
                    } else f = "center" === i ? (c.left + c.right) / 2 - b + e : Hs(t, i, e);
                    (g = ft(s, r, n)), (p = "left" === i ? -E : E);
                }
                return { titleX: f, titleY: g, maxWidth: u, rotation: p };
            })(this, h, e, l);
            Ve(t, i.text, 0, 0, a, { color: i.color, maxWidth: u, rotation: f, textAlign: qs(l, e, s), textBaseline: "middle", translation: [c, d] });
        }
        draw(t) {
        ...
        _createDescriptors(t, e) {
            const i = t && t.config,
                ...
                n = (function (t) {
                    ...
                    for (let t = 0; t < s.length; t++) i.push(Js.getPlugin(s[t]));
                    const n = t.plugins || [];
            ...
            return !1 !== s || e
                ? (function (t, { plugins: e, localIds: i }, s, n) {
                      ...
                      for (const r of e) {
                          const e = r.id,
                              l = tn(s[e], n);
                          null !== l && o.push({ plugin: r, options: en(t.config, { plugin: r, local: i[e] }, l, a) });
                      }
                      return o;
                  })(t, n, s, e)
                : [];
    ...
    function nn(t, e) {
        ...
        var i;
        if ((t = e.axis || ("top" === (i = e.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || (t.length > 1 && nn(t[0].toLowerCase(), e)))) return t;
    ...
    function hn(t, e) {
        let i = rn.get(t);
        return i || ((i = e()), rn.set(t, i), ln.add(i)), i;
    }
    const cn = (t, e, i) => {
        const s = M(e, i);
        void 0 !== s && t.add(s);
    ...
    class dn {
        constructor(t) {
            (this._config = (function (t) {
                return ((t = t || {}).data = an(t.data)), on(t), t;
            })(t)),
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set();
            e.forEach((e) => {
                t && (r.add(t), e.forEach((e) => cn(r, t, e))), e.forEach((t) => cn(r, s, t)), e.forEach((t) => cn(r, re[n] || {}, t)), e.forEach((t) => cn(r, ue, t)), e.forEach((t) => cn(r, le, t));
            });
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), ln.has(e) && o.set(e, l), l;
        }
        chartOptionScopes() {
    ...
    function un(t, e, i) {
        ...
        let o = s.get(n);
        if (!o) {
            (o = { resolver: He(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }), s.set(n, o);
        }
        return o;
    }
    ...
    class wn {
        ...
        constructor(t, e) {
            ...
            (this.platform = new (s.platform || vs(n))()), this.platform.updateConfig(s);
            ...
            (this.id = i()),
                ...
                (this._dataChanges = []),
                (yn[this.id] = this),
                r && l ? (xt.listen(this, "complete", bn), xt.listen(this, "progress", xn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
        ...
        _resize(t, e) {
            ...
            (this.width = o.width),
                ...
                (this._aspectRatio = this.aspectRatio),
                we(this, a, !0) && (this.notifyPlugins("resize", { size: o }), d(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
        }
        ensureScalesHaveIDs() {
            ...
            e &&
                ...
                u(n, (e) => {
                    const n = e.options,
                        ...
                        a = nn(o, n),
                        r = l(n.type, e.dtype);
                    (void 0 !== n.position && pn(n.position, a) === pn(e.dposition)) || (n.position = e.dposition), (s[o] = !0);
                    let h = null;
                    if (o in i && i[o].type === r) h = i[o];
                    else {
                        (h = new (Js.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })), (i[h.id] = h);
                    }
                    h.init(n, t);
                }),
                u(s, (t, e) => {
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (
                    ...
                    Object.assign(e, { dataElementType: Js.getElement(a), datasetElementType: s && Js.getElement(s) }), (n.controller = new e(this, i)), t.push(n.controller);
                }
            }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) && (xt.has(this) ? this.attached && !xt.running(this) && xt.start(this) : (this.draw(), bn({ chart: this })));
        }
        draw() {
            let t;
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) &&
                (s && Re(e, { left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom }),
                t.controller.draw(),
                s && Ie(e),
                (o.cancelable = !1),
        ...
        destroy() {
            ...
            this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Ae(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)), delete yn[this.id], this.notifyPlugins("afterDestroy");
        }
        toBase64Image(...t) {
    ...
    function An(t, e, i, s) {
        const n = t.iScale,
            ...
            l = [];
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) (u = e[h]), (d = {}), (d[n.axis] = r || n.parse(a[h], h)), l.push(On(u, d, o, h));
        return l;
    }
    function Tn(t) {
    ...
    function Ln(t, e, i, s) {
        ...
        "middle" === n && i && ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[En(c, a, r, l)] = !0), (n = h))), (o[En(n, a, r, l)] = !0), (t.borderSkipped = o);
    }
    function En(t, e, i, s) {
        var n, o, a;
        return s ? ((a = i), (t = Rn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e))) : (t = Rn(t, e, i)), t;
    }
    function Rn(t, e, i) {
        ...
        BarController: class extends Vs {
            ...
            parseObjectData(t, e, i, s) {
                const { iScale: n, vScale: o } = t,
                    ...
                    c = [];
                let d, u, f, g;
                for (d = i, u = i + s; d < u; ++d) (g = e[d]), (f = {}), (f[n.axis] = n.parse(M(g, l), d)), c.push(On(M(g, h), f, o, d));
                return c;
            }
            updateRangeFromParsed(t, e, i, s) {
            ...
            updateElements(t, e, i, n) {
                ...
                for (let f = e; f < e + i; f++) {
                    ...
                    Ln(m, b, p, a), In(m, b, c.ratio), this.updateElement(t[f], f, m, n);
                }
            }
            _getStacks(t, e) {
            ...
            _getRuler() {
                ...
                return { min: a || Cn(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage };
            }
    ...
    function Hn(t, e, i, s, n) {
        ...
        if (!h) return;
        d ? ((t.lineWidth = 2 * h), (t.lineJoin = c || "round")) : ((t.lineWidth = h), (t.lineJoin = c || "bevel"));
        let u = e.endAngle;
        if (o) {
            Wn(t, e, i, s, u, n);
        ...
        const e = Qn(t),
            ...
            n = (function (t, e, i) {
                const s = t.options.borderWidth,
                    n = t.borderSkipped,
                    o = yi(s);
                return { t: to(n.top, o.top, 0, i), r: to(n.right, o.right, 0, e), b: to(n.bottom, o.bottom, 0, i), l: to(n.left, o.left, 0, e) };
            })(t, i / 2, s / 2),
            a = (function (t, e, i) {
    ...
    var oo = Object.freeze({
        ...
        PointElement: class extends Bs {
            ...
            draw(t, e) {
                const i = this.options;
                this.skip || i.radius < 0.1 || !Ee(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Te(t, i, this.x, this.y));
            }
            getRange() {
                const t = this.options || {};
    ...
    class ho extends Ks {
        ...
        buildTicks() {
            ...
            const n = (function (t, e) {
                ...
                let D = 0;
                for (b && (u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, lo(a, y, t)) && D++) : M < a && D++); D < k; ++D) i.push({ value: Math.round((M + D * S) * v) / v });
                return x && u && w !== r ? (i.length && V(i[i.length - 1].value, r, lo(r, y, t)) ? (i[i.length - 1].value = r) : i.push({ value: r })) : (x && w !== r) || i.push({ value: w }), i;
            })(
                {
                    maxTicks: i,
                    bounds: t.bounds,
    ...
    function mo(t, { min: e, max: i }) {
        ...
        for (; f < i; ) s.push({ value: f, major: go(f), significand: u }), u >= 10 ? (u = u < 15 ? 15 : 20) : u++, u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)), (f = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
        const g = r(t.max, f);
        return s.push({ value: g, major: go(g), significand: u }), s;
    }
    class bo extends Ks {
        ...
        handleTickRangeOptions() {
            ...
            const n = (e) => (i = t ? i : e),
                o = (t) => (s = e ? s : t);
            i === s && (i <= 0 ? (n(1), o(10)) : (n(fo(i, -1)), o(fo(s, 1)))), i <= 0 && n(fo(s, -1)), s <= 0 && o(fo(i, 1)), (this.min = i), (this.max = s);
        }
        buildTicks() {
            const t = this.options,
    ...
    class Po extends ho {
        ...
        drawBackground() {
            ...
            if (t) {
                const i = this.ctx;
                i.save(), i.beginPath(), So(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), (i.fillStyle = t), i.fill(), i.restore();
            }
        }
        drawGrid() {
            const t = this.ctx,
                ...
                (e.pointLabels.display &&
                    (function (t, e) {
                        ...
                        for (let o = e - 1; o >= 0; o--) {
                            ...
                            Ve(i, t._pointLabels[o], r, l + a.lineHeight / 2, a, { color: e.color, textAlign: h, textBaseline: "middle" });
                        }
                    })(this, a),
                n.display &&
                        ...
                        if (0 !== e) {
                            ...
                            !(function (t, e, i, s, n) {
                                ...
                                (!a && !s) ||
                                    ...
                                    !l ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = r), (o.lineWidth = l), o.setLineDash(n.dash), (o.lineDashOffset = n.dashOffset), o.beginPath(), So(t, i, a, s), o.closePath(), o.stroke(), o.restore());
                            })(this, s, l, a, r);
                        }
                    }),
                i.display)
    ...
    function To(t, e, i, s) {
        ...
        for (let o = Co.indexOf(t); o < n - 1; ++o) {
            ...
            if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return Co[o];
        }
        return Co[n - 1];
    }
    function Lo(t, e, i) {
    ...
    class Ro extends Ks {
        ...
        buildTicks() {
            ...
            return (
                (this._unit =
                    e.unit ||
                    (i.autoSkip
                        ? To(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
                        : (function (t, e, i, s, n) {
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (let e = Co.indexOf(t) + 1, i = Co.length; e < i; ++e) if (Do[Co[e]].common) return Co[e];
                          })(this._unit)
                        : void 0),
                this.initOffsets(s),
                t.reverse && o.reverse(),
        ...
        _generate() {
            ...
            for (d = f, u = 0; d < i; d = +t.add(d, a, o), u++) Lo(c, d, g);
            return (
                (d !== i && "ticks" !== s.bounds && 1 !== u) || Lo(c, d, g),
                Object.keys(c)
                    .sort((t, e) => t - e)
                    .map((t) => +t)
            );
        ...
        getLabelTimestamps() {
            ...
            for (e = 0, i = s.length; e < i; ++e) t.push(Ao(this, s[e]));
    ...
    var zo = Object.freeze({
        ...
        TimeSeriesScale: class extends Ro {
            ...
            initOffsets() {
                ...
                (this._minPos = Io(e, this.min)), (this._tableRange = Io(e, this.max) - this._minPos), super.initOffsets(t);
            }
            buildLookupTable(t) {
    ...
    function Wo(t) {
        ...
        return (i, s) => {
            ...
            n instanceof zn
                ...
                : n instanceof Fn
                ? (e = (function (t, e) {
                      return (t.backgroundColor = t.data.map(() => No(e++))), e;
                  })(i, e))
                : n &&
                  (e = (function (t, e) {
                      return (t.borderColor = Bo(e)), (t.backgroundColor = No(e)), ++e;
                  })(i, e));
        };
    }
    function Ho(t) {
    ...
    var Uo = {
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                if (u <= (i.threshold || 4 * n)) return void $o(e);
                let f;
                switch (
                    (s(a) &&
                        ((e._data = h),
    ...
    function Go(t, e) {
        ...
        return (
            ...
            i.length ? new Zn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
        );
    }
    function Zo(t) {
        return t && !1 !== t.fill;
    ...
    function sa(t) {
        ...
        if ("stack" === i)
            return (function (t) {
                ...
                for (let t = 0; t < o.length; t++) {
                    const e = o[t];
                    for (let t = e.start; t <= e.end; t++) ta(n, a[t], r);
                }
            ...
            if ((t.scale || {}).getPointPositionForValue)
                return (function (t) {
                    ...
                    if (s.grid.circular) {
                        ...
                        return new ia({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(r) });
                    }
    ...
    function na(t, e, i) {
        ...
        s &&
            ...
            (function (t, e) {
                ...
                t.save(), "x" === l && o !== n && (oa(t, s, a.top), aa(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), oa(t, s, a.bottom));
                aa(t, { line: i, target: s, color: o, scale: r, property: l }), t.restore();
    ...
    function aa(t, e) {
                ...
                for (const t of s) {
                    ...
                    for (const e of h) {
                        const s = Xo(i, o[e.start], o[e.end], e.loop),
                            r = Li(t, n, s);
                        for (const t of r) a.push({ source: t, target: e, start: { [i]: Ko(l, s, "start", Math.max) }, end: { [i]: Ko(l, s, "end", Math.min) } });
                    }
                }
                return a;
            })(i, s, n);
        for (const { source: e, target: l, start: h, end: c } of r) {
            const { style: { backgroundColor: r = o } = {} } = e,
                d = !0 !== s;
            t.save(), (t.fillStyle = r), ra(t, a, d && Xo(n, h, c)), t.beginPath();
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    (r = o.dataset),
                    (l = null),
                    r && r.options && r instanceof Zn && (l = { visible: t.isDatasetVisible(a), index: a, fill: Qo(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
            for (a = 0; a < s; ++a) (l = n[a]), l && !1 !== l.fill && (l.fill = Jo(n, a, i.propagate));
        },
        beforeDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const i = n[e].$filler;
                i && (i.line.updateControlPoints(o, i.axis), s && i.fill && na(t.ctx, i, o));
            }
        },
    ...
    class da extends Bs {
        ...
        _draw() {
            ...
            (f = b ? { x: ft(n, this.left + c, this.right - i[0]), y: this.top + c + x, line: 0 } : { x: this.left + c, y: ft(n, this.top + x + c, this.bottom - e[0].height), line: 0 }), Ci(this.ctx, t.textDirection);
            const _ = m + c;
            this.legendItems.forEach((y, v) => {
                ...
                if (
                    ...
                    (function (t, e, i) {
                        Ve(s, i.text, t, e + m / 2, h, { strikethrough: i.hidden, textAlign: r.textAlign(i.textAlign) });
                    })(r.x(S), P, y),
                    b)
                )
                    f.x += k + c;
    ...
    var fa = {
        ...
        _element: da,
        start(t, e, i) {
            const s = (t.legend = new da({ ctx: t.ctx, options: i, chart: t }));
    ...
    class ga extends Bs {
        ...
        draw() {
            ...
            Ve(t, e.text, 0, 0, i, { color: e.color, maxWidth: a, rotation: r, textAlign: ut(e.align), textBaseline: "middle", translation: [n, o] });
        }
    }
    var pa = {
        id: "title",
        ...
        start(t, e, i) {
            !(function (t, e) {
                const i = new ga({ ctx: t.ctx, options: e, chart: t });
    ...
    var ba = {
        id: "subtitle",
        start(t, e, i) {
            const s = new ga({ ctx: t.ctx, options: i, chart: t });
            ns.configure(t, s, i), ns.addBox(t, s), ma.set(t, s);
        },
        stop(t) {
            ns.removeBox(t, ma.get(t)), ma.delete(t);
        },
        beforeUpdate(t, e, i) {
            const s = ma.get(t);
            ns.configure(t, s, i), (s.options = i);
    ...
    function ka(t, e, i) {
        ...
        return { xAlign: i.xAlign || e.xAlign || wa(t, e, i, s), yAlign: s };
    }
    function Sa(t, e, i, s) {
    ...
    class Ta extends Bs {
        ...
        getContext() {
            return this.$context || (this.$context = ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Pi(t, { tooltip: e, tooltipItems: i, type: "tooltip" })));
            var t, e, i;
        }
        getTitle(t, e) {
            const { callbacks: i } = e,
            ...
            let a = [];
            return (a = _a(a, ya(s))), (a = _a(a, ya(n))), (a = _a(a, ya(o))), a;
        }
        getBeforeBody(t, e) {
            ...
            return (
                u(t, (t) => {
                    const e = { before: [], lines: [], after: [] },
                        n = Ca(i, t);
                    _a(e.before, ya(Aa(n, "beforeLabel", this, t))), _a(e.lines, Aa(n, "label", this, t)), _a(e.after, ya(Aa(n, "afterLabel", this, t))), s.push(e);
                }),
                s
            );
        }
        ...
        _createItems(t) {
            ...
            let a,
                r,
                l = [];
            for (a = 0, r = e.length; a < r; ++a) l.push(va(this.chart, e[a]));
            return (
                t.filter && (l = l.filter((e, s, n) => t.filter(e, s, n, i))),
                t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))),
                u(l, (e) => {
                    const i = Ca(t.callbacks, e);
                    s.push(Aa(i, "labelColor", this, e)), n.push(Aa(i, "labelPointStyle", this, e)), o.push(Aa(i, "labelTextColor", this, e));
                }),
                (this.labelColors = s),
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Pa(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = wi(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
            ...
            if (n.usePointStyle) {
                ...
                Object.values(r).some((t) => 0 !== t)
                    ? (t.beginPath(),
                      ...
                      t.fill())
                    : ((t.fillStyle = n.multiKeyBackground), t.fillRect(e, p, h, l), t.strokeRect(e, p, h, l), (t.fillStyle = a.backgroundColor), t.fillRect(i, p + 1, h - 2, l - 2));
            }
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Pa(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = wi(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
        ...
        draw(t) {
            ...
            e.enabled &&
                a &&
                (t.save(), (t.globalAlpha = i), this.drawBackground(n, t, s, e), Ci(t, e.textDirection), (n.y += o.top), this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), Oi(t, e.textDirection), t.restore());
        }
        getActiveElements() {
            return this._active || [];
        }
